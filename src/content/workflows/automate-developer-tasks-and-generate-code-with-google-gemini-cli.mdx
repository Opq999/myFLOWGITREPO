...
2.  **Install Gemini CLI globally**: In your terminal, run the following command to install the Gemini CLI globally on your system. This makes the `gemini` command available from any directory. You may be prompted to enter your system password.
