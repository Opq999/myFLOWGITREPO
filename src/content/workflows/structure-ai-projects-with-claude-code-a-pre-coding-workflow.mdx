...
nigeriaNotes: "Claude Code needs a paid Claude plan or API credits (card payment); the Gemini CLI is a free alternative for the same steps. GitHub has a free tier for public repositories. Data usage is minimal, primarily text-based interactions."
nigeriaUseCases:
  - persona: "student"
