...
nigeriaNotes: "Claude Code needs a paid Claude plan or API credits (card payment). Free alternative: the Gemini CLI has a generous free tier and handles the same kind of refactoring. Data usage depends on the size of your codebase and the length of the interaction. VSCode is a desktop application and does not consume mobile data."
nigeriaUseCases:
  - persona: "employee"
