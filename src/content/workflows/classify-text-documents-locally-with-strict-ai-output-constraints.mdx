...
nigeriaUseCases:
  - persona: "small-business"
    scenario: "Automatically sort incoming WhatsApp customer messages into categories like 'new order', 'payment proof', 'delivery inquiry', or 'complaint' to quickly prioritize replies."
  - persona: "student"
    scenario: "Categorize research articles for your final year project into 'literature review', 'methodology', 'results', 'discussion', or 'future work' to streamline your writing process."
  - persona: "entrepreneur"
    scenario: "Classify customer feedback from your social media DMs or survey responses into 'bug report', 'feature request', 'usability issue', 'pricing query', or 'general praise' to inform product development."
tiktokUrl: ""
published: true
---
