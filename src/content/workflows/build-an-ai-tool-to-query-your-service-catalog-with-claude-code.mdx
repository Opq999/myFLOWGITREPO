...
nigeriaUseCases:
  - persona: "employee"
    scenario: "As a software engineer, build an AI agent tool to instantly query your company's internal service catalog, finding the owner or on-call person for any application service without manual searching."
  - persona: "student"
    scenario: "As a final-year Computer Science student interning at a tech company, develop an AI tool to query their microservice catalog for ownership and deployment details, streamlining your project research."
  - persona: "entrepreneur"
    scenario: "As a tech startup founder, create an AI-powered internal tool for your engineering team to instantly look up details (owner, deploy target) for any of your product's microservices, improving incident response."
tiktokUrl: ""
published: true
---
