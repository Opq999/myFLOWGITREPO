...
nigeriaUseCases:
  - persona: "student"
    scenario: "When using ChatGPT to research for my final year project, I'll add guard prompts to prevent it from fabricating sources or statistics, ensuring my research is credible for my supervisor."
  - persona: "entrepreneur"
    scenario: "When using AI to draft a business plan for my new tech startup, I'll use guard prompts to ensure it doesn't invent market research data or financial projections, keeping my plan realistic."
  - persona: "employee"
    scenario: "When using AI to draft a summary of a complex client report, I'll apply guard prompts to ensure it doesn't misinterpret key data points or invent conclusions, maintaining accuracy for my manager."
tiktokUrl: ""
published: true
---
