...
nigeriaUseCases:
  - persona: "student"
    scenario: "Test Python coding models for JAMB/university assignments by creating prompt files and a scoring rubric in Google Sheets."
  - persona: "employee"
    scenario: "Evaluate AI coding assistants for office tasks by saving prompts to text files and scoring responses in Excel."
tiktokUrl: ""
published: true
---
