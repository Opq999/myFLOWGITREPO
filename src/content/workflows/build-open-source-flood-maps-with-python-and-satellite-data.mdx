...
nigeriaUseCases:
  - persona: "student"
    scenario: "Generate a flood extent map for your university town using Python and satellite data to analyze local flood risks for a geography project."
  - persona: "employee"
    scenario: "Automate the creation of flood impact reports for your company's assets in flood-prone regions using Python and satellite data."
tiktokUrl: ""
published: true
---
