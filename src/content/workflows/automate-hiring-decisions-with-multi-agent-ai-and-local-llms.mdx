...
nigeriaUseCases:
  - persona: "employee"
    scenario: "A software engineer in a large Nigerian bank's HR department could implement this workflow to automate the initial screening of thousands of graduate trainee applications, standardizing evaluation and flagging complex cases for human review"
  - persona: "entrepreneur"
    scenario: "An entrepreneur building an HR tech startup could integrate this workflow to power their automated candidate screening and shortlisting service for clients, ensuring consistent evaluation and reducing manual effort."
tiktokUrl: ""
published: true
---
