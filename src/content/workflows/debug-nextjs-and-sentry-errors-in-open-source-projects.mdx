...
nigeriaUseCases:
  - persona: "employee"
    scenario: "Troubleshoot why Sentry isn't capturing errors from your company's Next.js application, ensuring production issues are logged and fixed quickly."
  - persona: "student"
    scenario: "Debug database connection issues in your Next.js side hustle project using Prisma, so your app runs locally for testing before launch."
  - persona: "entrepreneur"
    scenario: "Fix silent Sentry errors in your startup's Next.js product, ensuring you catch all user-facing bugs before they impact customers."
tiktokUrl: ""
published: true
---
