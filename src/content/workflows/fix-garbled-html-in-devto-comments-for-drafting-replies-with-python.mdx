...
nigeriaUseCases:
  - persona: "student"
    scenario: "Clean garbled HTML from DEV.to comments to draft replies to your technical articles."
  - persona: "employee"
    scenario: "Process raw HTML comments from DEV.to API into plain text for drafting replies to your articles."
tiktokUrl: ""
published: true
---
