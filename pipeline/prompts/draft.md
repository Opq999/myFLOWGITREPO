...
3. `## Steps` — numbered list. EVERY prompt goes in its own fenced code block. Keep steps concrete and reproducible.
...

{
  "frontmatter": {
    ...
    "description": string,    // SEO meta description, 140-160 characters
